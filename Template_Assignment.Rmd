...
housing_costs <- read.csv("data/Opbouw_binnenlands_product__bbp__03062026_161330.csv")

renter_households <- read.csv("data/Woningen__m___type__bouwjaar__regio_03062026_161143.csv")
```
